object frmAgendaTecnicos: TfrmAgendaTecnicos
  Left = 0
  Top = 0
  Caption = ':: Agenda de T'#233'cnicos ::'
  ClientHeight = 490
  ClientWidth = 895
  Color = cl3DLight
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object pgTecnicos: TPageControl
    Left = 0
    Top = 40
    Width = 900
    Height = 442
  ...
  object qSigaTecnicos: TSQLQuery
    MaxBlobSize = -1
    Params = <>
    SQL.Strings = (
      
        'select * from abb010 where (abb010.ABB_DTINI > 20080101 and abb0' +
        '10.ABB_DTFIM >20080101) order by abb010.ABB_DTINI;')
    SQLConnection = frmPrincipal.SQLConnection1
    Left = 416
    Top = 328
    object qSigaTecnicosABB_FILIAL: TStringField
      FieldName = 'ABB_FILIAL'
      Required = True
      FixedChar = True
      Size = 2
    end
    object qSigaTecnicosABB_CODTEC: TStringField
      FieldName = 'ABB_CODTEC'
      Required = True
      FixedChar = True
      Size = 6
    end
    object qSigaTecnicosABB_NUMOS: TStringField
      FieldName = 'ABB_NUMOS'
      Required = True
      FixedChar = True
      Size = 6
    end
    object qSigaTecnicosABB_DTINI: TStringField
      FieldName = 'ABB_DTINI'
      Required = True
      FixedChar = True
      Size = 8
    end
    object qSigaTecnicosABB_HRINI: TStringField
      FieldName = 'ABB_HRINI'
      Required = True
      FixedChar = True
      Size = 5
    end
    object qSigaTecnicosABB_DTFIM: TStringField
      FieldName = 'ABB_DTFIM'
      Required = True
      FixedChar = True
      Size = 8
    end
    object qSigaTecnicosABB_HRFIM: TStringField
      FieldName = 'ABB_HRFIM'
      Required = True
      FixedChar = True
      Size = 5
    end
    object qSigaTecnicosABB_ATENDE: TStringField
  ...
  object qPegaTecnicos: TSQLQuery
    MaxBlobSize = -1
    Params = <>
    SQL.Strings = (
    ...
    Left = 472
    Top = 328
    object qPegaTecnicosaa1_codtec: TStringField
      FieldName = 'aa1_codtec'
      Required = True
      FixedChar = True
      Size = 6
    end
    object qPegaTecnicosaa1_tecage: TStringField
